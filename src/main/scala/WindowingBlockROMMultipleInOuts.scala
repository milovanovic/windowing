...
abstract class WindowingBlockROMMultipleInOuts [T <: Data : Real: BinaryRepresentation, D, U, E, O, B <: Data] (val params: WindowingParams[T], beatBytes: Int) extends LazyModule()(Parameters.empty) with DspBlock[D, U, E, O, B] with HasCSR {
...
class AXI4WindowingBlockROMMultipleInOuts[T <: Data : Real: BinaryRepresentation](params: WindowingParams[T], address: AddressSet, beatBytes: Int = 4)(implicit p: Parameters) extends WindowingBlockROMMultipleInOuts[T, AXI4MasterPortParameters, AXI4SlavePortParameters, AXI4EdgeParameters, AXI4EdgeParameters, AXI4Bundle](params, beatBytes) with AXI4DspBlock with AXI4HasCSR {
...
object WindowingBlockROMMultipleInOutsApp extends App
{
  ...
  val testModule = LazyModule(new AXI4WindowingBlockROMMultipleInOuts(paramsWindowing, address = AddressSet(0x010000, 0xFF), beatBytes = 4) with WindowingROMMultipleInOutsStandaloneBlock {
